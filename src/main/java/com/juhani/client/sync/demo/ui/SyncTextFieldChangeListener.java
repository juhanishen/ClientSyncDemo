...
public class SyncTextFieldChangeListener implements ChangeListener<String> {
  ...
  public void changed(ObservableValue<? extends String> observable, String oldValue,
    ...
    if (!syncValueTokenChecked) {
      ...
      if(tokenOperand.isTokenTaken() && (!tokenOperand.getClientName().equalsIgnoreCase(clientName))){       
        ...
        MongoUtil.getInstance().upsertToken(Constants.SyncFieldId,clientName,Constants.TokenTaken);
